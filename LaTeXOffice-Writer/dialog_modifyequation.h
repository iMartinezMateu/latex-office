#ifndef DIALOG_MODIFYEQUATION_H
#define DIALOG_MODIFYEQUATION_H
...
#include "constants.h"
namespace Ui {
class Dialog_ModifyEquation;
}

class Dialog_ModifyEquation : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    /**
      ...
      */
    explicit Dialog_ModifyEquation(TeXFile* file, int selectedLineNumber, QString compilerPath, QWidget *parent = 0);
    /*************************************************************************************************/
    /**
      @brief This function destroys the dialog reference.
      @returns This is a void function.
      */
    ~Dialog_ModifyEquation();
    /*************************************************************************************************/
    /**
      @brief This function sets the equation LaTeX Code from the current file.
      @returns This is a void function.
      */
    void setEquationCode();
    /*************************************************************************************************/
    /**
      @brief This function returns the equation.
      @returns This function returns the equation LaTeX code typed in the UI.
      */
    QString getEquation();
