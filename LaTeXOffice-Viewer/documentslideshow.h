#ifndef DOCUMENTSLIDESHOW_H
#define DOCUMENTSLIDESHOW_H
...
namespace Ui {
class DocumentSlideShow;
}

class DocumentSlideShow : public QWidget
{
    Q_OBJECT
...
public:
    ...
    /**
      ...
      */
    explicit DocumentSlideShow(QWidget *parent = 0);
    /*************************************************************************************************/
    /**
